		...
		<ul class="caption-style-2">
          ...
          <?php
            ...
            foreach ($images as $key => $value) {
                echo "<li><a href=\"detail.php?id=
                {$key}\" class=\"img-responsive\"><img src=\"images/square/{$value["path"]}\" alt=\"
                {$value["title"]}\"><div class=\"caption\"><div class=\"blur\"></div><div class=\"caption-text\"><h1>
                {$value["title"]}</h1></div></div></a></li>
                ";
            }
          ?>
